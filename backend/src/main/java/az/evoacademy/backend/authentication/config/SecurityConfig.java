package az.evoacademy.backend.authentication.config;

import az.evoacademy.backend.authentication.jwt.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/v1/auth/**", "/api/v1/course/**","/error","/api/v1/whatYouLearn/**").permitAll() // Auth ve Course endpoint'leri açık
